...
class WAConnection extends _3_Connect_1.WAConnection {
    constructor() {
        ...
        this.on('CB:action,add:relay,received', json => {
            json = json[2][0][1];
            const chat = this.chats.get(Utils_1.whatsappID(json.jid));
            const msg = chat === null || chat === void 0 ? void 0 : chat.messages.get(Utils_1.GET_MESSAGE_ID({ id: json.index, fromMe: json.owner === 'true' }));
            if (msg) {
                const MAP = {
